...
class Block:
    ...
    def render(self, window) -> None: #TODO: Este parametro necesita ser la ventana donde se va a renderiar.
        ...
        if self.__color != COLORS["black"]:
            pygame.draw.line(window, line_color, self.__rect.topleft,self.__rect.bottomleft,line_width)
            pygame.draw.line(window, line_color, self.__rect.bottomleft,self.__rect.bottomright,line_width)
            pygame.draw.line(window, line_color, self.__rect.bottomright,self.__rect.topright,line_width)
            pygame.draw.line(window, line_color, self.__rect.topright,self.__rect.topleft,line_width)
        if self.__is_penalty:
            pygame.draw.line(window, COLORS["white"], self.__rect.topleft, self.__rect.bottomright, 3)
            pygame.draw.line(window, COLORS["white"], self.__rect.bottomleft,self.__rect.topright,3)
